...
public class DataLoader {
    public UnifiedHeirarchicalObject loadContent(MultipartFile file) throws Exception {
        ...
        if ("xml".equalsIgnoreCase(extension)) {
            ...
            object = loadJSON(file);
        }

        return object;
    }

    private UnifiedHeirarchicalObject loadXML(MultipartFile file) throws Exception {
    ...
    private UnifiedHeirarchicalObject loadJSON(MultipartFile file) {
        return null;
    }
}
